...
df_us = df.loc[(df['county'] == 'Multnomah') & (df['state'] == 'Oregon')]
...
fig1.update_layout(hovermode="x unified", # consistent hover
    ...
    xaxis_title="Date",
    yaxis_title="Count",
    title="COVID-19 Cases & Deaths in Portland, OR",
...
fig1.write_html(file="../../docs/plots/portland_lines.html",auto_play=True,full_html=False,include_plotlyjs='cdn',
